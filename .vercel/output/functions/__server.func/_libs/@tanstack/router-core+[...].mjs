import { b as invariant, x as decodePath, y as createLRUCache } from "./react-router+[...].mjs";
...
var INITIAL_SCRIPTS = [mn(SCOPE_ID), "self.$_TSR={h(){this.hydrated=!0,this.c()},e(){this.streamEnded=!0,this.c()},c(){this.hydrated&&this.streamEnded&&(delete self.$_TSR,delete self.$R.tsr)},p(e){this.initialized?e():this.buffer.push(e)},buffer:[]}"];
		...
		dehydrate: async (opts) => {
			...
			if (manifest) {
				...
				if (opts?.requestAssets?.length) {
					...
					manifestToDehydrate.routes["__root__"] = {
						...existingRoot,

...
import { _ as isResolvedRedirect, b as invariant, f as require_jsx_runtime, g as isRedirect, h as executeRewriteInput, i as RouterProvider, m as resolveManifestAssetLink, p as require_react, t as renderRouterToStream, v as isNotFound } from "./_libs/@tanstack/react-router+[...].mjs";
import { n as createMemoryHistory } from "./_libs/tanstack__history.mjs";
import { a as mergeHeaders, c as createSerializationAdapter, d as au, f as ou, i as getOrigin, l as makeSerovalPlugin, n as attachRouterServerSsrUtils, o as defaultSerovalPlugins, r as getNormalizedURL, s as createRawStreamRPCPlugin, t as defineHandlerCallback, u as Iu } from "./_libs/@tanstack/router-core+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CB9kVja9.mjs");
	const startManifest = tsrStartManifest();
	const rootRoute = startManifest.routes["__root__"] = startManifest.routes["__root__"] || {};
...
async function transformManifestAssets(source, transformFn, _opts) {
	...
	const rootRoute = manifest2.routes["__root__"] = manifest2.routes["__root__"] || {};
	rootRoute.assets = rootRoute.assets || [];
...
function buildManifestWithClientEntry(source) {
	...
	const baseRootRoute = source.manifest.routes["__root__"];
	return { routes: {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./_chunks/router-Bla56fIb.mjs"),
		import("./_chunks/start-HYkvq4Ni.mjs"),
